...
[![npm version](https://img.shields.io/npm/v/@manufosela/browser-closure-notice.svg)](https://www.npmjs.com/package/@manufosela/browser-closure-notice)
...
```bash
pnpm add @manufosela/browser-closure-notice
```

### 🎬 Demo

https://manufosela.github.io/utils/packages/browser-closure-notice/demo/
...
```javascript
import { BrowserClosureNotice } from '@manufosela/browser-closure-notice';
...
```html
<script type="module">
  import { BrowserClosureNotice } from './src/browser-closure-notice.js';
